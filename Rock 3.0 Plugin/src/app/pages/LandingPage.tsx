...
export default function LandingPage() {
  ...
  // Clear unhappy path flag when on the regular landing page
  useEffect(() => {
    sessionStorage.removeItem('pmm-unhappy-path');
  }, []);
  ...
  useEffect(() => {
    const checkNoCst = () => {
      ...
      console.log('CST Upsell Check:', { noCst, dismissed, viewCount });
  ...
  const handleOrderClick = (path: string) => {
    console.log('=== LandingPage handleOrderClick ===');
    ...
    // On the home page (LandingPage), ALWAYS go through candidate-selection first
